...
# Fail2Ban
log_section 2 "INSTALLING AND CONFIGURING FAIL2BAN"
...
log_section 3 "CONFIGURING UFW FIREWALL"
...
# Docker
log_section 4 "INSTALLING DOCKER"
...
# Dokploy
log_section 5 "INSTALLING DOKPLOY"
